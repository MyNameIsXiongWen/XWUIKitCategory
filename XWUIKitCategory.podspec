#
# Be sure to run `pod lib lint XWUIKitCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XWUIKitCategory.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/MyNameIsXiongWen/XWUIKitCategory.git', :tag => s.version.to_s }
